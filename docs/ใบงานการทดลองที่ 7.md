...
1. Z-score มีข้อจำกัดอะไรบ้าง — ยกตัวอย่างกรณีที่ Z-score ไม่สามารถตรวจจับความผิดปกติได้ และถ้าค่าเฉลี่ยกับค่าเบี่ยงเบนมาตรฐานเปลี่ยนไปตามช่วงเวลา (เช่น กลางวันร้อน กลางคืนเย็น) ควรปรับปรุงวิธีอย่างไร
2. การให้ Edge ตัดสินใจแทน Cloud มีข้อดีข้อเสียอย่างไร — ถ้า ESP32 หลุดจาก WiFi หรือ n8n หยุดทำงาน Alarm จะหายไปหรือไม่ — มีวิธีสำรองอย่างไร
3. จงออกแบบระบบ AIoT ที่ใช้ Edge Intelligence + Workflow Automation สำหรับตรวจสอบสถานีฐานโทรคมนาคม 10 แห่ง — อธิบายสถาปัตยกรรม การเลือกช่องทางแจ้งเตือน (Telegram Bot vs Discord Webhook) และ MQTT Topic Design