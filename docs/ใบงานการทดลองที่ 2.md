...
graph LR
    ...
    subgraph BKR["📡 MQTT Broker"]
        BK["broker.hivemq.com<br/>Port 1883<br/><b>ตัวกลาง</b>"]
    end
...
mosquitto_sub -h broker.hivemq.com -p 1883 -t "kmutnb/66010001/telemetry"
    ```

    หรือใช้ **HiveMQ WebSocket Client** ที่ [hivemq.com/mqtt](http://www.hivemq.com/demos/websocket-client/) → Subscribe เพื่อดูข้อมูลแบบ GUI
