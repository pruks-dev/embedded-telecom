...
4. เปิด ESP32 โดยให้เชื่อมต่อ WiFi และ MQTT Broker (IP ของ Pi)
   - **Mesh Sensor/Relay** (จาก Lab 6) — ส่งข้อมูลผ่าน ESP-NOW ไปยัง Mesh Gateway
   - **Mesh Gateway** (จาก Lab 6.3) — รับ ESP-NOW แล้ว publish ผ่าน MQTT
5. ตรวจสอบว่าระบบทั้ง 3 บริการทำงานพร้อมกัน
...
| NOC Dashboard | 5000 | | |
| n8n | 5678 | | |
| Mesh Gateway (ESP32) | - (ESP-NOW + MQTT) | | |
...
| MAJOR Alarm | ESP32 → Local Alarm Logic | | |
